...
import { NtLoadingState, DataPlaceholderAccessor, NgTreaterSetting } from '../interface';
...
export class DataPlaceHolderDirective implements OnInit  {
  ...
  placeholder!: ComponentRef<DataPlaceholderAccessor>;
...
export class PlaceholderComponent implements DataPlaceholderAccessor {
